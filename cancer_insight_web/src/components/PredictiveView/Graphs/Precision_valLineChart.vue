/* File for Precision_val */
Precision_val<!-- This is the trend chart for Precision_val -->
<script setup>
...
const handleChartData = async () => {
    ...
    chartData.value = message.value.map(item => [item.epoch, item.precision_val]); 
    updateChart();
};
...
const updateChart = () => {
    ...
    const option = {
        title: {
            text: 'Training Performance of Precision_val Over Epochs',
            left: 20,
            top: 20,
        },
        grid: {
